...
sudo apt-get install python-setuptools python-dev python-pip python-virtualenv libavcodec-dev libavformat-dev libav-tools libswscale-dev libjpeg62 libfreetype6 libfreetype6-dev libopencv-dev python-opencv mysql-server-5.5 mysql-client-5.5 libmysqlclient-dev gfortran rabbitmq-server cmake libboost-all-dev build-essential
