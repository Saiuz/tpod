function instructions(job, h)
{
    ...
    h.append('<ul class="keyboardshortcuts">' +
        '<li>n creates a new object</li>' +
        '<li>t toggles play/pause on the video</li>' +
        '<li>r rewinds the video to the start</li>' +
        '<li>h hides/shows the boxes (only after clicking Options button)</li>' +
        '<li>d jump the video forward a bit</li>' +
        '<li>f jump the video backward a bit</li>' +
        '<li>v step the video forward a tiny bit</li>' +
        '<li>c step the video backward a tiny bit</li>' +
        '</ul>');
}
